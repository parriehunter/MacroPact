...
keyboard.keymap = [
    [KC.LSFT(KC.I),      KC.S,       KC.LALT(KC.L),       KC.LALT(KC.D),       KC.3,       KC.F2,     KC.1,     KC.NO,
     KC.L,      KC.LCTL(KC.L),       KC.LSFT(KC.L),    KC.LALT(KC.R),       KC.LSFT(KC.B),       KC.LSFT(KC.A),       KC.LSFT(KC.E),       KC.LSFT(KC.T),
     KC.LSFT(KC.D),      KC.LCTL(KC.D),       KC.LALT(KC.LEFT),    KC.LALT(KC.RIGHT),       KC.LCTL(KC.B),       KC.LCTL(KC.A),       KC.LCTL(KC.E),       KC.LCTL(KC.T),
     ],
